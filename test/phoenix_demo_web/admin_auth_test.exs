defmodule PhoenixDemoWeb.AdminAuthTest do
  use PhoenixDemoWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias PhoenixDemo.Accounts
  alias PhoenixDemoWeb.AdminAuth
  import PhoenixDemo.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PhoenixDemoWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_admin/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      PhoenixDemoWeb.Endpoint.subscribe(live_socket_id)
