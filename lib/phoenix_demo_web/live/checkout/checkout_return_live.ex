    ...
    <div class="flex flex-col gap-16">
      ...
      <% else %>
        <div role="alert" class="alert alert-error">
          ...
          <span>Error! El proceso de pago ha fallado: <%= @stripe_error %></span>
        </div>
      <% end %>
      ...
      <div class="w-full flex justify-center">
        <%= if @is_success == true do %>
          <div class="prose text-center">
            <p>
              Se ha completado el pago y el pedido se ha realizado con éxito.
            </p>
            <p>
            ...
            <p>
              Recibirás un nuevo correo con número de seguimiento.
            </p>
          </div>
        <% else %>
